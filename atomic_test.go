...
func TestNewAtomicInt32(t *testing.T) {
	...
	if ai32.Get() != 233 {
		t.Errorf("want 233, got %s", ai32.Get())
	}
	ai32.Add(2100)
	if ai32.Get() != 2333 {
		t.Errorf("want 2333, got %s", ai32.Get())
	}
	if !ai32.CompareAndSwap(2333, 1234) {
		t.Errorf("want true, got false")
	}
	if ai32.Get() != 1234 {
		t.Errorf("want 1234, got %s", ai32.Get())
	}
...
func TestNewAtomicInt64(t *testing.T) {
	...
	if ai64.Get() != 233 {
		t.Errorf("want 233, got %s", ai64.Get())
	}
	ai64.Add(2100)
	if ai64.Get() != 2333 {
		t.Errorf("want 2333, got %s", ai64.Get())
	}
	if !ai64.CompareAndSwap(2333, 1234) {
		t.Errorf("want true, got false")
	}
	if ai64.Get() != 1234 {
		t.Errorf("want 1234, got %s", ai64.Get())
	}
